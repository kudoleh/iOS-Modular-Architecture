...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../DevPods/MoviesSearch/MoviesSearch/Module/Assets/Assets.xcassets"
  install_resource "${PODS_ROOT}/../DevPods/MoviesSearch/MoviesSearch/Module/Data/PersistentStorages/CoreDataStorage/CoreDataStorage.xcdatamodeld"
fi
